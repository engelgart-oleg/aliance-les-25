  ...
  <section class="head">
    ...
    <div class="repeat-block">
      <div class="container">
        ...
        <div class="repeat-block-wrapper">
          ...
          <h2 class="repeat-block-title">О компании</h2>
          <ul class="breadcrumb">
    ...
    <div class="repeat-block repeat-block-image">
      <div class="container">
        ...
        <div class="repeat-block-wrapper">
          <div class="seporator"></div>
          <h2 class="repeat-block-title">Автомобильная химия</h2>
          <ul class="breadcrumb">
            <li class="breadcrumb-item">
              <a class="breadcrumb-link" href="#">Главная</a>
            </li>
    ...
    <div class="repeat-block repeat-block-bg">
      <div class="container">
    
        <div class="repeat-block-wrapper">
          <div class="seporator"></div>
          <h2 class="repeat-block-title repeat-block-title-white">
          ...
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item breadcrumb-item-white">
              <a class="breadcrumb-link" href="#">Блог</a>
            </li>
            <li class="breadcrumb-item breadcrumb-item-white active">
              Современная методология разработки одухотворила всех причастных
            </li>
          </ul>
          <!-- /.breadcrumbs -->
