...
<body>
    ...
    <div class="modal-dialog">
      ...
      <form class="modal-form" method="POST" action="handler.php">
        ...
        <div class="input-group-wrapper input-group-vertical">
          ...
          <div class="input-group modal-input-group">
            <input class="input modal-input phone-mask-modal" id="modal-user-phone" type="tel" name="userphone" placeholder=" " maxlength="30" required>
  ...
  <div class="modal modal-thank is-open">
